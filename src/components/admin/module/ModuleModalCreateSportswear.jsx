        ...
        <div>
            <div>
                <button type="button" className="btn btn-secondary px-4 py-3" data-toggle="modal" data-target="#exampleModalCenter" >
                    <strong><i class="fa-solid fa-circle-plus"></i></strong> Add Sportswear
                </button>
                                ...
                                <div className="content-text p-4">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="form-group">
                                            <label for="email">Name Sportswear</label>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="input-select">
                                                <select className="form-select" name="categoryName"
                                                    ...
                                                    <option value="Jeseys">Jeseys</option>
                                                    <option value="Trainingwear">Trainingwear</option>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="name">Related-photo</label>
                                            <input
                                                type="file"
