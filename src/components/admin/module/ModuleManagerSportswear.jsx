...
function ModuleManagerSportswear() {
    ...
    const fetchSportswear = async () => {
        try {
            ...
            const response = await SportswearService.getAllSportswearByAdmin(token, key, noPage, categoryName);
                        ...
                        <div className="col-lg-12 d-flex align-items-stretch">
                            <div className="card w-100">
                                <div className="card-body p-4">
                                    <h5 className="card-title fw-semibold mb-4">Building List</h5>
                                                    ...
                                                    <div className="card card-body" key={item.id}>
                                                        <div className="media align-items-center align-items-lg-start  text-lg-left flex-column flex-lg-row">
                                                            <div className="mr-2 mb-3 mb-lg-0">
                                                                ...
                                                                <img src={item.main_image} width="150" height="150" alt="" />
                                                            ...
                                                            <div className="media-body">
                                                                ...
                                                                <ul className="list-inline list-inline-dotted mb-3 mb-lg-2">
                                                                    <li className="list-inline-item text-danger">Status :</li>
                                                                    <li className="list-inline-item">{item.status === 1 ? <p className="text-secondary">Available</p> : <p className="text-danger">Disable</p>}</li>

                                                                </ul>
                                                                <ul className="list-inline list-inline-dotted mb-3 mb-lg-2">
                                                                    <li className="list-inline-item text-danger">Quantity :</li>
                                                            ...
                                                            <div className="mt-3 mt-lg-0 ml-lg-3 text-center">
                                                                ...
                                                                <ModuleModalUpdateSportswear sportswear={item}// Truyền item cần cập nhật vào UpdateModal
                                                                />
