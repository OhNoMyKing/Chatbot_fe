...
function Search() {
  ...
  const { key, setKey, categoryName, setCategoryName } =
  ...
  useEffect(() => {
    ...
    }, 30000000000); // Thời gian trì hoãn (debounce) là 300ms
            ...
            >
              <div className="input-select">
                ...
                >
                  ...
                  <option value="CLB">Club Shirt</option>
                  <option value="NATIONAL">National Shirt</option>
                  <option value="PLAYER">Player Shirt</option>
                </select>
              </div>
            </div>
